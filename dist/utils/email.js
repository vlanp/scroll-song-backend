...
const sendEmail = async (recipient, subject, text, transporterName = "RESEND") => {
    const mailOptions = {
        from: transporterName === "RESEND"
    ...
    return (transporterName === "RESEND" ? resendTransporter : zohoTransporter).sendMail(mailOptions);
};
export { sendEmail };
